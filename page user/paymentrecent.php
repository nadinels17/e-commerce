...
<nav class="navbar navbar-light" style="background-color: #FFB6C1;">
  <div class="container-fluid">
    ...
    <ol class="breadcrumb mb-4" style="margin-left: -140px; margin-top: 30px; font-size: 30px;">
...
<tr class="table-danger">
      <th><?=$no++?></th>
      <td><a href="detailpayment.php?id_pesanan=<?=$data['id_pesanan'];?>" style="color:black;"><?= $data['nama'];?></a></td>
      <td><?= $data['alamat'];?></td>
