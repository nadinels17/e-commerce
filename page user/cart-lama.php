...
<table class="table">
  ...
  <tbody>
    ...
    <?php 
        ...
        $data = mysqli_query($conn, "SELECT * FROM shop WHERE id_produk= '$id_produk'");
    ...
    <tr class="table-danger">
      ...
      <td><?= $ambildata['nm_produk'];?></td>
      <td>Rp <?=$ambildata['harga'];?>,00</td>
      <td><?=$ambildata($jumlah);?></td>
      <td><?=$ambildata($totalharga);?></td>
