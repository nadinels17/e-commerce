...
<body>
    <nav class="navbar navbar-light" style="background-color: #FFB6C1;">
        <div class="container-fluid">
            ...
            <ol class="breadcrumb mb-4" style="margin-left: -20px; margin-top: 30px; font-size: 30px;">
                <li class="breadcrumb-item"><a style="color:grey; font-size: 30px; margin-left: 580px;"
                        href="index.php">Home</a></li>
                <li class="breadcrumb-item active"><a style="color:grey; font-size: 30px; " href="shop.php">Profile</a>
                </li>
            </ol>
  ...
  ?>
    ...
    <br><br><br>
    <a href="logout.php" style="margin-left: 170vh; font-size:20px;">
    ...
    <div class="row mt-5">
        ...
        <div class="col">
            <svg xmlns="http://www.w3.org/2000/svg" width="450" height="450" fill="currentColor"
        ...
        <div class="col">
            <h1>Nama</h1>
            <h2 class="user"><?= $_SESSION['nama']; ?></h2>
            <br>
            <h1>Email</h1>
            <h2 class="useremail"><?= $_SESSION['email']; ?></h2>
            <br><br>
            <a href="edituser.php" class="btn btn-info">Edit</a>
    ...
    <div class="card mx-5" style="width: 75rem;">
        <div class="card-body" style="background-color: #FFB6C1;">
            <h5 class="card-title">Info Account</h5>
        </div>
        <ul class="list-group list-group-flush">
            <li class="list-group-item ne"><a class="nav-link" style="color:rgb(52, 125, 209)"
                    href="paymentrecent.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                    ...
                    Recently Payments</a></li>
            <li class="list-group-item ne"><a class="nav-link" style="color:rgb(52, 125, 209)" href="">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="bi bi-heart-fill" viewBox="0 0 16 16">
                        <path fill-rule="evenodd"
                            d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314z" />
                    </svg> Produk disukai</a></li>
            <li class="list-group-item ne"><a class="nav-link" style="color:rgb(52, 125, 209)" href="cart.php">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="bi bi-cart" viewBox="0 0 16 16">
                        <path
                            d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .491.592l-1.5 8A.5.5 0 0 1 13 12H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l1.313 7h8.17l1.313-7H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z" />
                    </svg> Cart</a></li>
            <li class="list-group-item ne"><a class="nav-link" style="color:rgb(52, 125, 209)" href=""><svg
                    ...
                    Bantuan?</a></li>
            <!--<li class="list-group-item ne"><a class="nav-link" style="color:rgb(52, 125, 209)" href="">Macaron</a></li> -->
        </ul>
    </div>
