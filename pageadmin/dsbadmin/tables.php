...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark" style="background-color: #FAA0A0;">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.php">NLS' Mochies</a>
            <!-- Sidebar Toggle-->
                ...
                <nav class="sb-sidenav accordion" style="background-color: #E37383;" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a style="color: white;" class="nav-link" href="charts.php">
                                <div class="sb-nav-link-icon"><i class="fas fa-chart-area"></i></div>
                                Charts
                            </a>
                            <a style="color: white;" class="nav-link" href="tables.php">
                            ...
                            <a style="color: white;" class="nav-link" href="customers.php">
                                <div class="sb-nav-link-icon"><i class="fa fa-users"></i></div>
                                Customers
                            </a>
                            <a style="color: white;" class="nav-link" href="users.php">
