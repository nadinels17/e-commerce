                                    ...
                                    <div class="card-body">
                                        <form action="" method="POST" enctype="multipart/form-data">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="inputFirstName" name= "namaawal" type="text" placeholder="Enter your first name" />
                                                        <label for="inputFirstName">Name Admin</label>
                                                    </div>
                                            ...
                                            <div class="mt-4 mb-0">
                                                <button class="btn btn-primary btn-block d-grid" type="submit" name="register">Create Account</button>
                                            </div>
                                        </form>
                                    </div>
