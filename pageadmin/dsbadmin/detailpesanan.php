                    ...
                    <div class="container-fluid px-4">
                        ...
                        <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0" method="POST">
                            ...
                            <input class="form-control" style="margin-left: 50rem;" type="text" name="name" placeholder="Search for..." aria-label="Search for..." aria-describedby="btnNavbarSearch"/>
                               ...
                               <a href="excel2.php" class="btn btn-danger">EXPORT TO EXCEL</a>
...
<div class="row">
  ...
  <div class="col"></div>
    ...
    if (isset($_POST['search'])) {
      $search = $_POST['nama'];
      $query2 = mysqli_query($conn, "SELECT * FROM pemesanan WHERE nama = '$search'");
    }

    $data = mysqli_query($conn, "SELECT * FROM pemesanan");
    $jumlahpesanan= mysqli_num_rows($data);
  
  ?>

  <p style="font-size: 20px; color: grey;">Jumlah Pesanan : <?=$jumlahpesanan;?></p>
...
<tr class="table-danger">
      <th><?=$no++?></th>
      <td><a href="detail.php?id_pesanan=<?=$data['id_pesanan'];?>" style="color:black;"><?= $data['nama'];?><a></td>
