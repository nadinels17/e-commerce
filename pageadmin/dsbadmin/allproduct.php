        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark" style="background-color: #FAA0A0;">
            ...
            <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0" method="POST">
                <div class="input-group">
                    ...
                    <button class="btn btn-danger" id="btnNavbarSearch" type="submit"><i class="fas fa-search">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <a style="text-decoration: none; color: #D3D3D3; " href="tambahproduk.php"><button type="button" class="btn btn-outline-secondary">Add new</button></a> <br><br>
                        <!-- Navbar Search-->
                        <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0" method="POST">
                        <br>
                            ...
                            <div class="input-group">
                                ...
                                <button class="btn btn-danger" name="search" id="btnNavbarSearch" type="submit"><i class="fas fa-search">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search-heart" viewBox="0 0 16 16">
                                <path d="M6.5 4.482c1.664-1.673 5.825 1.254 0 5.018-5.825-3.764-1.664-6.69 0-5.018Z"/>
                                <path d="M13 6.5a6.471 6.471 0 0 1-1.258 3.844c.04.03.078.062.115.098l3.85 3.85a1 1 0 0 1-1.414 1.415l-3.85-3.85a1.007 1.007 0 0 1-.1-.115h.002A6.5 6.5 0 1 1 13 6.5ZM6.5 12a5.5 5.5 0 1 0 0-11 5.5 5.5 0 0 0 0 11Z"/>
                                </svg>
...
<div class="row">
  ...
  <div class="col"></div>
    ...
    $jumlahproduk= mysqli_num_rows($data);
  
  ?>

  <p style="font-size: 20px; color: grey;">Jumlah produk : <?=$jumlahproduk;?></p>
...
if (isset($_POST['search'])) {
    $search = $_POST['cari'];
    $query = mysqli_query($conn, "SELECT * FROM shop WHERE nm_produk LIKE '%$search%'");
...
?>
  ...
  <?php foreach ($query as $data) :?>
    <tr class="table-danger">
      <th><?=$no++?></th>
      <td>
        <img src="image/<?=$data['gambar'];?>" width="50px" alt="">
      </td>
      <td><?= $data['nm_produk'];?></td>
      <td><?= $data['deskripsi'];?></td>
      <td><?= $data['harga'];?></td>
      <td>
        <a class="btn btn-danger" href="delete.php?id_produk=<?=$data['id_produk'];?>">DELETE</a><br><br>
        <a class="btn btn-info" href="edit_data.php?id_produk=<?=$data['id_produk'];?>">EDIT</a>
      </td>
