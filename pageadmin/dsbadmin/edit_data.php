...
<div class="container">
  <div class="row">
    ...
    <form action="" method="post" enctype="multipart/form-data">
      ...
      <input class="form-control" type="text" value="<?=$data['nm_produk'];?>" name="nm_produk" id="">
</br>
      <label class="form-label" for="">Deskripsi</label>
      <input class="form-control" type="text" value="<?=$data['deskripsi'];?>" name="deskripsi" id="">
</br>
      <label class="form-label" for="">Harga produk</label>
      <input class="form-control" type="text" value="<?=$data['harga'];?>" name="harga" id="">
<!-- </br>
      ...
      <input class="form-control" type="file" value="<?=$data['gambar'];?>" name="gambar" id="">
    
    </br><br>

      <button type="submit" class="btn btn-success" name="submit" >Edit Produk</button>
    </form>
    </br> </br>
    </div>
    <?php endforeach;?>
